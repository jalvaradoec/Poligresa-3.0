		...
		<div class="row">
            ...
            <div class="box-body no-padding">
               <table  class="table  table-hover">
				...
				<?php
			   $sql="select * from App_Phones WHERE App_Phones_DebtorID ='".$row["App_Credits_DebtorId"]."' AND App_Phones_PhoneStatus='1' limit 3";			   
				$result=mysql_query($sql);
				?>
				<tr>
                  <td><b>Phone:</b></td>
            ...
            <!-- /.box-header -->
              ...
              <table id="example2" class="table table-bordered table-hover">
				...
				/*
					...
					*/															
					echo $sql="select l.App_Logs_Id,l.App_Logs_DateTime,l.App_Logs_Answer,l.App_Logs_Contact,l.App_Logs_Type,l.App_Logs_TransAmmount,l.App_Logs_TransDateTime,l.App_Logs_Notes,a.App_Aux_text as respuesta,aa.App_Aux_text as contactto,aaa.App_Aux_text as telefono
							from App_Logs l 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		if(isset($_GET['contactid'])){
				...
				$sql="select * from App_Credits ac INNER JOIN App_Clients ac1 ON ac.App_Credits_DebtorId = ac1.App_Clients_DebtorIdNumber INNER JOIN App_Phones ap ON ac.App_Credits_DebtorId = ap.App_Phones_DebtorID WHERE  ac.App_Credits_BankOperNumber ='".$_GET['operno']."' ";
				}
				$result=mysql_query($sql);
				$row=mysql_fetch_array($result);
		...
		<div class="col-lg-4">-->
		  ...
		  <div class="form-group">
			...
			<div class="box-body">			
				<div class="col-lg-12">		  	
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-12 control-label" style="text-align: left; !importent">Outcome:</label>
						<div class="col-sm-12" style="width: 100%;">
							<textarea class="form-control" rows="5" name="outcome" required ></textarea>
						</div>
					</div>
						...
						<div class="box-body">
							<div class="col-lg-4">
								...
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-4 control-label">Down Payment:</label>
									<div class="col-sm-8">
										<input type="text" class="form-control dpaymentc" name="dpaymentc" onchange="setTwoNumberDecimal2()" >
									</div>
								</div>										  
							</div>
							<div class="col-lg-4">
