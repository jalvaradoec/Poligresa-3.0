		...
		<div class="col-lg-4">
          ...
          <table id="example2" class="table table-bordered table-responsive table-hover">
			...
			else
			{
			  ...
			  $sql4="select * from View_AgremTable aa INNER JOIN App_Credits ac ON ac.App_Credits_DebtorId = aa.App_Transactions_ClientID WHERE ac.App_Credits_AssignedTo ='".$_SESSION["logged_in_user"]["App_Users_ID"]."' and aa.App_Transactions_ShareStatus!='4' and aa.App_Transactions_ShareStatus!='6' and aa.App_Transactions_OperationID='".$row['App_Transactions_OperationID']."' and ac.App_Credits_BankOperNumber='".$row['App_Transactions_OperationID']."' and aa.App_Transactions_ShareDueDate<='".Date("m")."'";
			}
				 $result3=mysql_query($sql3);
