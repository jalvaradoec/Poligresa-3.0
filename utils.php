...
function getAppCredits($appCreditsCond = null){
    global $objDb;
    $appCredits = array();
    $appCreditsSql = "SELECT ac.*,vos.App_Aux_text StatusText,acl.App_Clients_FullName,acl.App_Clients_FirstName,act.App_Contacts_PhoneNumber,acp.App_Phones_DebtorID FROM `App_Credits` ac 
