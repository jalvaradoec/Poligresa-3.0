...
function getAppCredits($appCreditsCond = null){
    ...
    $appCreditsSql = "SELECT ac.*,vos.App_Aux_text StatusText,acl.App_Clients_FullName,acl.App_Clients_FirstName,acp.App_Phones_PhoneNumber FROM `App_Credits` ac 
